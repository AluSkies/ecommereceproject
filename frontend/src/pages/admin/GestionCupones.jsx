...
export function GestionCupones() {
  ...
  const fetchDiscounts = async (filterKey = filter) => {
    ...
    try {
      ...
      setError(err instanceof ApiError ? err.message : 'Error al cargar los cupones.')
    } finally {
      setLoading(false)
    }
  }
  ...
  const executeToggle = async (discount) => {
    ...
    try {
      ...
      setActionError(err instanceof ApiError ? err.message : 'No se pudo cambiar el estado del cupón.')
    }
  }
  ...
  const executeDelete = async (id) => {
    ...
    try {
      ...
      setActionError(err instanceof ApiError ? err.message : 'No se pudo eliminar el cupón. Si ya fue usado en una venta, te recomendamos desactivarlo.')
    }
  }
